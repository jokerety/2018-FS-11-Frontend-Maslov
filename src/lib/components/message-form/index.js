...
const template = `
	...
	<form>
		...
		<form-input name="firstname_text" placeholder="Введите имя" slot="message-input">
			<span slot="icon"></span>
		</form-input>
		<form-input name="secondname_text" placeholder="Введите фамилию" slot="message-input">
			<span slot="icon"></span>
		</form-input>
		<form-input name="phonenumber_text" placeholder="Введите номер телефона" slot="message-input">
			<span slot="icon"></span>
		</form-input>
	</form>
`;
